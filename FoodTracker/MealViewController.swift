...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        // Set up views if ediitng an existing Meal.
        if let meal = meal {
        ...
        // Enable the Save button only if the text field has a valide Meal name.
        checkValidMealName()
    }
    ...
    func imagePickerControllerDidCancel(picker: UIImagePickerController) {
        // Dismaiss the picker if user cancels
    ...
    @IBAction func selectImageFromPhotoLibrary(sender: UITapGestureRecognizer) {
        ...
        // Make sure ViewController is notigied when the user picks an image.
